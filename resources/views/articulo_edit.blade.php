        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="h3 mb-0">Editar Artículo</h1>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="descripcion" id="descripcion" value="{{old("descripcion",$articulo->descripcion)}}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="precio_unitario" id="precio_unitario" value="{{old("precio_unitario",$articulo->precio_unitario)}}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="cantidad" id="cantidad" value="{{old("cantidad",$articulo->cantidad)}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="alerta_minima" id="alerta_minima" value="{{old("alerta_minima",$articulo->alerta_minima)}}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @enderror
                                <div class="mt-2">
                                    <img src="{{url("img/$articulo->foto")}}" alt="{{$articulo->descripcion}}" class="img-thumbnail" style="height: 100px;">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select name="unidades_id" id="unidades_id" class="form-select @error('unidades_id') is-invalid @enderror" onchange="mostrarImagenUnidad(this)">
                                            @foreach($unidades as $unidad)
                                                <option value="{{$unidad->id}}" data-imagen="{{url('img/'.$unidad->foto)}}" {{$unidad->id==old("unidad_id",$articulo->unidad_id)?"selected":""}}>
                                                    {{$unidad->descripcion}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select name="categorias_id" id="categorias_id" class="form-select @error('categorias_id') is-invalid @enderror" onchange="mostrarImagenCategoria(this)">
                                            @foreach($categorias as $categoria)
                                                <option value="{{$categoria->id}}" data-imagen="{{url('img/'.$categoria->foto)}}" {{$categoria->id==old("categoria_id",$articulo->categoria_id)?"selected":""}}>
                                                    {{$categoria->nombre}}
                                                </option>
                                            @endforeach
                                        </select>
