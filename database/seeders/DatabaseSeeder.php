...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Articulo::create(["descripcion" => "Pintura Roja (1L)", "cantidad" => 15, "precio_unitario" => 20, "foto" => "pintura_roja.png", "unidades_id" => 1, "categorias_id" => 4, "alerta_minima" => 5]);
        ...
        Articulo::create(["descripcion" => "Tornillo (paquete de 50)", "cantidad" => 200, "precio_unitario" => 10, "foto" => "tornillo.png", "unidades_id" => 1, "categorias_id" => 3, "alerta_minima" => 10]);
        Articulo::create(["descripcion" => "Brocha", "cantidad" => 40, "precio_unitario" => 5, "foto" => "brocha.png", "unidades_id" => 1, "categorias_id" => 4, "alerta_minima" => 5]);
        ...
        Articulo::create(["descripcion" => "Martillo", "cantidad" => 30, "precio_unitario" => 15, "foto" => "martillo.png", "unidades_id" => 1, "categorias_id" => 1, "alerta_minima" => 20]);
        Articulo::create(["descripcion" => "Pintura Blanca (1L)", "cantidad" => 20, "precio_unitario" => 18, "foto" => "pintura_blanca.png", "unidades_id" => 1, "categorias_id" => 4, "alerta_minima" => 5]);
        Articulo::create(["descripcion" => "Tornillo Allen (paquete de 50)", "cantidad" => 150, "precio_unitario" => 12, "foto" => "tornillo_allen.png", "unidades_id" => 1, "categorias_id" => 3, "alerta_minima" => 10]);
        ...
        Articulo::create(["descripcion" => "Cemento (saco 50kg)", "cantidad" => 100, "precio_unitario" => 80, "foto" => "cemento.png", "unidades_id" => 1, "categorias_id" => 3, "alerta_minima" => 10]);
        ...
        Articulo::create(["descripcion" => "Pegamento para Madera", "cantidad" => 60, "precio_unitario" => 6, "foto" => "pegamento_madera.png", "unidades_id" => 1, "categorias_id" => 3, "alerta_minima" => 10]);
        ...
        Articulo::create(["descripcion" => "Pintura Azul (1L)", "cantidad" => 15, "precio_unitario" => 18, "foto" => "pintura_azul.png", "unidades_id" => 1, "categorias_id" => 4, "alerta_minima" => 5]);
        Articulo::create(["descripcion" => "Caja de Herramientas", "cantidad" => 10, "precio_unitario" => 75, "foto" => "caja_herramientas.png", "unidades_id" => 1, "categorias_id" => 1, "alerta_minima" => 10]);
        Articulo::create(["descripcion" => "Adhesivo Epóxico", "cantidad" => 40, "precio_unitario" => 12, "foto" => "adhesivo_epoxico.png", "unidades_id" => 1, "categorias_id" => 3, "alerta_minima" => 10]);
