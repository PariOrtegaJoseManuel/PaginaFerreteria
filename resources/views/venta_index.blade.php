            ...
            <div class="card-body">
                    ...
                    <form action="{{ route('ventas.index') }}" method="GET">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" list="razon" class="form-control shadow-sm"
                                    placeholder="Ingrese la razón social" name="razon" value="{{ old('razon') }}">
                                <datalist id="razon">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control shadow-sm" name="fecha"
                                    value="{{ old('fecha') }}">
                            </div>
                ...
                <div class="table-responsive">
                                            ...
                                            <div class="btn-group" role="group">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body p-4">
                                                                ...
                                                                <form action="{{ route('ventas.update', $venta) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="clientes_id"
                                                                            class="form-label fw-bold">Cliente</label>
                                                                        <select name="clientes_id" id="clientes_id"
                                                                            class="form-select">
                                                                            @foreach ($clientes as $cliente)
                                                                                <option value="{{ $cliente->id }}"
                                                ...
                                                @can('ventas.destroy')
                                                    <button type="button" class="btn btn-outline-danger shadow-sm"
                                                        data-bs-toggle="modal" data-bs-target="#exampleModal{{ $venta->id }}">
                    ...
                    <div class="container mt-4">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <form action="{{ route('ventas.reporteDiario') }}" method="GET"
