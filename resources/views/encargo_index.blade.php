            ...
            <div class="card-body">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                    @foreach ($encargos as $encargo)
                                ...
                                <div class="position-relative">
                                    <div style="width: 100%; padding-bottom: 100%; position: relative;">
                                        <img class="card-img-top position-absolute w-100 h-100"
                                            src="{{ url("img/$encargo->foto") }}" alt="{{ $encargo->descripcion_articulo }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-1"><strong>Estado:</strong>
                                            <span
                                                class="badge {{ $encargo->estado == 'Pendiente' ? 'bg-warning' : ($encargo->estado == 'Completado' ? 'bg-primary' : 'bg-danger') }}">
                                                {{ $encargo->estado }}
                                            </span>
                                        </p>
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        @if ($encargo->estado == 'Pendiente')
                                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCancelar{{ $encargo->id }}">
                        ...
                        <!-- Modal Cancelar -->
                        <div class="modal fade" id="modalCancelar{{ $encargo->id }}" tabindex="-1"
                            aria-labelledby="modalCancelarLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-danger text-white">
                                        <h5 class="modal-title" id="modalCancelarLabel">
                                            <i class="fas fa-ban me-2"></i>Cancelar Encargo
                                        </h5>
                                    ...
                                    <div class="modal-body text-center p-4">
                                        ...
                                        <h5 class="mb-3">¿Está seguro que desea cancelar este encargo?</h5>
                                        <h2 class="text-danger mb-4">Encargo #{{ $encargo->id }}</h2>
                                        <img src="{{ url("img/$encargo->foto") }}"
                                            alt="{{ $encargo->descripcion_articulo }}" class="img-thumbnail mb-3"
                                            style="max-height: 150px;">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button type="button" class="btn btn-lg btn-light" data-bs-dismiss="modal">
                                                <i class="fas fa-times me-2"></i>Cancelar
                                            </button>
                                            <form action="{{ route('encargos.updateEstado', $encargo) }}" method="post">
                                                @method('PUT')
                                                @csrf
